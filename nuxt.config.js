...
export default {
    ...
    head: {
        ...
        meta: [{
            ...
            },
            {
                ...
                property: 'og:image',
                content: "https://desarquivo.github.io/favicon.ico"
            }, {
                property: 'og:title',
                content: "Desarquivo"
            }, {
                ...
                property: 'og:url',
                content: "https://desarquivo.github.io"
            }, {
                property: 'og:locale',
                content: "pt"
            }
    ...
    axios: {
        ...
        baseURL: process.env.DEPLOY_ENV === 'GH_PAGES' ? "https://rocky-spire-69467.herokuapp.com/http://35.234.109.95/" : "http://localhost:5000/"
    },
    /*
